      ...
      <div className="mx-auto max-w-screen-2xl py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="lg:col-span-5">
            <h3 className="text-xl font-bold mb-3 bg-gradient-to-r from-[var(--location-blue-600)] via-[var(--gold-base)] to-[var(--location-blue-700)] bg-clip-text text-transparent">
              Suniel Kapoor
            </h3>
            
            <p className="text-sm text-[var(--location-gray-600)] leading-relaxed mb-5 max-w-md">
            ...
            <div className="flex gap-3 mb-6">
              {[Facebook, Instagram, Linkedin].map((Icon, i) => (
                <a
                  key={i}
                  className="flex items-center justify-center w-10 h-10 rounded-lg bg-white border-2 border-[var(--gold-light)] text-[var(--gold-base)] hover:bg-[var(--gold-light)] hover:border-[var(--gold-base)] hover:scale-105 transition-all shadow-sm"
                  href="#"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-center gap-3 text-[var(--location-blue-800)] text-sm">
                  <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-[var(--gold-light)]">
          ...
          <div className="lg:col-span-4 grid grid-cols-2 gap-8">
            <div>
              <strong className="text-sm font-bold text-[var(--location-blue-800)] mb-4 block">
                Quick Links
              </strong>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-xl p-6 shadow-lg border border-[var(--gold-light)] hover:shadow-xl transition-shadow">
              <h4 className="text-sm font-bold text-[var(--location-blue-800)] mb-2">Ready to Find Your Dream Property?</h4>
              <p className="text-xs text-[var(--location-gray-600)] mb-4 leading-relaxed">
        ...
        {/* Bottom Bar */}
        <div className="mt-8 pt-6 border-t border-[var(--gold-light)]">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
            <p className="text-xs text-[var(--location-gray-600)]">
              © 2024 Company. All rights reserved.
            </p>
            <div className="flex gap-6 text-xs text-[var(--location-gray-600)]">
